...
<div class="row">
    <div class="col-lg-8 col-sm-8 col-md-8 col-xs-12">
        <h3>Listado de Artículos <a href="articulo/create"><button class="btn btn-success">Nuevo</button></a><a href="{{URL::action('PdfController@gen')}}"><button class="btn btn-primary">Reporte</button></a></h3>
